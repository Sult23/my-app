      ...
      <div className={style.inner}>
        <div className={style.form}>
          ...
          <div className={style.box}>
            <img src={person} />
            <input placeholder={`${t('form.name')}`} className={style.input} />
          </div>
          <div className={style.box}>
            <img src={bag} />
            <input
          ...
          <div className={style.box}>
            <img src={phone} />
            <input placeholder={`${t('form.phone')}`} className={style.input} />
          </div>
          <div className={style.box}>
            <img src={mail} />
            <input placeholder={`${t('form.mail')}`} className={style.input} />
          </div>
